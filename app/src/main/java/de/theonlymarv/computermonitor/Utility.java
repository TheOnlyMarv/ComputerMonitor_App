...
public class Utility {
    ...
    public static void ShowSnackBarOnMainActivity(Activity activity, @StringRes int text, @Snackbar.Duration int duration) {
        Snackbar.make(activity.findViewById(R.id.innerRootLayout), text, duration).show();
    }

    public static void ShowSnackBarOnMainActivity(Activity activity, String text, @Snackbar.Duration int duration) {
        Snackbar.make(activity.findViewById(R.id.innerRootLayout), text, duration).show();
    }
}
